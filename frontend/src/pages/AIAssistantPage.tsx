...
import { Send, Bot, User, Shield, Key, Lock, AlertTriangle } from 'lucide-react';
import { DashboardLayout } from '../components/DashboardLayout';
import { firebaseAssistantAPI } from '../services/firebase';
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-6 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
                    {messages.map((msg) => (
                        ...
                        >
                            ...
                            {/* Bubble */}
                            <div className={`
                                max-w-[85%] sm:max-w-[75%] rounded-2xl px-4 py-3 text-sm leading-relaxed whitespace-pre-wrap shadow-lg
                                ${msg.role === 'user'
